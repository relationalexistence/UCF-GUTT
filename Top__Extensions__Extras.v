...
(*
  ...
  |      - RelationClosures.refl_closure, sym_closure, trans_closure         |
  |      - RelationClosures.equiv_closure                                    |
  |      - Decidability.whole_completion_decidable                           |
  |      - Utilities.carrier_map, carrier_bind                               |
  |    EXPERIMENTAL (may change):                                            |
  |      - StructuralAnalysis module (API may evolve)                        |
  |      - Examples module (for demonstration only)                          |
  |                                                                          |
  |  NAMING CONVENTIONS:                                                     |
  |    - Closure functions: *_closure (refl_closure, sym_closure)            |
  |    - Properties: *_refl, *_sym, *_trans, *_incl, *_minimal               |
  |    - Monotonicity: *_mono                                                |
  |    - Decidability: *_decidable, *_dec                                    |
  |    - Utilities: carrier_* (carrier_map, carrier_bind)                    |
  |                                                                          |
